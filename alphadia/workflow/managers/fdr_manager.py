...
class FDRManager(BaseManager):
    def __init__(
        ...
        **kwargs,
        ...
        trainer : CrossFittedTrainer, optional
            Fits the classifier of the final FDR round. If None, the final round uses
            the same plain fit as the optimization rounds.
        """
