...
class DynamicLoader(ProcessingStep):
    def __init__(self, modification_mapping=None) -> None:
...
class FastaDigest(ProcessingStep):
    def __init__(
        self,
        enzyme: str = "trypsin",
        fixed_modifications: list[str] = None,
        variable_modifications: list[str] = None,
        missed_cleavages: int = 1,
        precursor_len: list[int] = None,
        precursor_charge: list[int] = None,
        precursor_mz: list[int] = None,
