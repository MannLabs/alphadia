...
def perform_fdr(  # noqa: C901, PLR0913 # too complex, too many arguments
    ...
    *,
    ...
    decoy_correction_factor: float = 1.0,
) -> pd.DataFrame:
    ...
    decoy_correction_factor: float, default=1.0
        A correction factor to apply to the number of decoys when calculating FDR.
    ...
    psm_df = get_q_values(
        psm_df, "proba", "_decoy", decoy_correction_factor=decoy_correction_factor
    )
...
def get_q_values(  # noqa: PLR0913
    ...
    fdr_values = (
        decoy_cumsum * decoy_correction_factor / target_cumsum
