...
class QuantBuilder:
    ...
    def lfq(
        ...
        logger.info(f"Performing label-free quantification with {normalize} normalization")
        ...
        if normalize == "quantselect":
            ...
            feature_layer, intensity_layer = pipeline.process(data=features, level=group_column)
