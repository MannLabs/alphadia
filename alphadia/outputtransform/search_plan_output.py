...
class SearchPlanOutput:
    ...
    def _build_precursor_table(
        ...
        # grouping and FDR run on the wider table so that a protein can be competed against its
        # own decoy; the precursors reported below are still only those passing the precursor FDR
