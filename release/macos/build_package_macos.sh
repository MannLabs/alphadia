...
APP_NAME="alphadia"
PACKAGE_VERSION="1.9.3-dev4"
PKG_FOLDER="dist/$APP_NAME.app"

# BUILD_NAME is taken from environment variables, e.g. alphadia-1.9.3-dev4-macos-darwin-arm64 or alphadia-1.9.3-dev4-macos-darwin-x64
