...
APP_NAME="alphadia"
PACKAGE_VERSION="2.1.1-dev0"
PKG_FOLDER="dist/$APP_NAME.app"

# BUILD_NAME is taken from environment variables, e.g. alphadia-2.1.1-dev0-macos-darwin-arm64 or alphadia-2.1.1-dev0-macos-darwin-x64
