...
const VersionCard = () => (
    <Card sx={{height: '200px', position:'relative'}}>
        <Box component="div" sx={{fontWeight:200, position:'absolute', left:"0", bottom:"0", p:2}}>
            <Typography component="span" sx={{fontWeight: 700, fontSize: "1.5rem", fontFamily:"Roboto Mono"}}>v</Typography>
            <Typography component="span" sx={{fontWeight: 200, fontSize: "3rem", fontFamily:"Roboto Mono", letterSpacing:"-0.2em" }}>1.0.1</Typography>
            <br/>
