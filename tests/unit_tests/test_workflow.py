...
def test_calibration_manager_init():
    ...
    calibration_manager = manager.CalibrationManager(TEST_CONFIG, path=temp_path, load_from_file=False)
...
def test_calibration_manager_save_load():
    ...
    calibration_manager_loaded = manager.CalibrationManager(TEST_CONFIG, path=temp_path, load_from_file=True)
...
def test_optimization_manager_save_load():
    ...
    optimization_manager = manager.OptimizationManager(OPTIMIZATION_TEST_DATA, path=temp_path, load_from_file=False)
    ...
    optimization_manager_loaded = manager.OptimizationManager(OPTIMIZATION_TEST_DATA, path=temp_path, load_from_file=True)
