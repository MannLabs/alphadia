...
def test_base_manager():
    ...
    assert not my_base_manager.is_loaded_from_file
    assert not my_base_manager.is_fitted
...
def test_base_manager_load():
    ...
    assert my_base_manager_loaded.is_loaded_from_file
    assert not my_base_manager_loaded.is_fitted
...
def test_calibration_manager_init():
    ...
    assert not calibration_manager.is_loaded_from_file
    assert not calibration_manager.is_fitted
...
def test_calibration_manager_fit_predict():
    ...
    assert calibration_manager.is_fitted
...
def test_calibration_manager_save_load():
    ...
    assert calibration_manager_loaded.is_fitted
    assert calibration_manager_loaded.is_loaded_from_file
...
def test_optimization_manager():
    ...
    assert not optimization_manager.is_loaded_from_file
    assert not optimization_manager.is_fitted
...
def test_optimization_manager_save_load():
    ...
    assert optimization_manager_loaded.is_loaded_from_file
    assert not optimization_manager_loaded.is_fitted
...
def test_workflow_base():
    ...
    for _name, file_list in pytest.test_data.items():
