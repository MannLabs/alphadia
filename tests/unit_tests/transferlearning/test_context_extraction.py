...
def test_resolve_context_model_path_explicit():
...
def test_resolve_context_model_path_auto_download():
...
def test_resolve_context_model_path_custom_subdir():
    ...
    with patch(
        ...
        result = resolve_context_model_path(
...
def test_resolve_context_model_path_explicit_overrides_subdir():
