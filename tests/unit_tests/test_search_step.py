...
@patch("alphadia.search_step.SearchStep._load_default_config")
def test_updates_with_user_config_object(
    mock_load_default_config
):
    ...
    assert result == {"key1": "value1", "key2": "value2b", "output_directory": "/output"}
...
def test_updates_with_user_and_cli_and_extra_config_dicts(
    ...
    config = Config({"key1": "value1", "key2": "value2", "key3": "value3", "key4": "value4", "output_directory": None})
    mock_load_default_config.return_value = deepcopy(config)
    ...
    assert result == {"key1": "value1", "key2": "value2b", "key3": "value3b", "key4": "value4b", "output_directory": "/output"}
