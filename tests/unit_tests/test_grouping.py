...
def construct_test_cases():
    ...
    distinct_proteins_input = {"precursor_idx": [1,2,3,4], "proteins": ["A", "A", "B", "B"], "decoy": [0,0,0,0]}
    distinct_proteins_expected = {"precursor_idx":[1,2,3,4], "proteins":["A", "A", "B", "B"], "decoy": [0,0,0,0], "pg_master":["A","A","B","B"], "pg":["A","A","B","B"]}

    differentiable_proteins_input = {"precursor_idx": [1,2,3,4], "proteins": ["A", "A;B", "A;B", "B"], "decoy": [0,0,0,0]}
    differentiable_proteins_expected = {"precursor_idx":[1,2,3,4], "proteins":["A", "A;B", "A;B", "B"], "decoy": [0,0,0,0], "pg_master":["A","A","A","B"], "pg":["A","A","A","B"]}

    indistinguishable_proteins_input = {"precursor_idx": [1,2,3,4], "proteins": ["A;B", "A;B", "A;B", "A;B"], "decoy": [0,0,0,0]}
    indistinguishable_proteins_expected = {"precursor_idx":[1,2,3,4], "proteins":["A;B", "A;B", "A;B", "A;B"], "decoy": [0,0,0,0], "pg_master":["A","A","A","A"], "pg":["A;B","A;B","A;B","A;B"]}

    subset_proteins_input = {"precursor_idx": [1,2,3,4], "proteins": ["A", "A;B", "A;B", "A;B"], "decoy": [0,0,0,0]}
    subset_proteins_expected = {"precursor_idx":[1,2,3,4], "proteins":["A", "A;B", "A;B", "A;B"], "decoy": [0,0,0,0], "pg_master":["A","A","A","A"], "pg":["A;B","A;B","A;B","A;B"]}

    subsumable_proteins_input = {"precursor_idx": [1,2,3,4], "proteins": ["A", "A;B", "B;C", "C"], "decoy": [0,0,0,0]}
    subsumable_proteins_expected = {"precursor_idx":[1,2,3,4], "proteins":["A", "A;B", "B;C", "C"], "decoy": [0,0,0,0], "pg_master":["A","A","C","C"], "pg":["A","A","C;B","C;B"]}

    shared_only_proteins_input = {"precursor_idx": [1,2,3,4], "proteins": ["A;B", "A;B;C", "A;B;C", "A;C"], "decoy": [0,0,0,0]}
    shared_only_proteins_expected = {"precursor_idx":[1,2,3,4], "proteins":["A;B", "A;B;C", "A;B;C", "A;C"], "decoy": [0,0,0,0], "pg_master":["A","A","A","A"], "pg":["A;B;C","A;B;C","A;B;C","A;B;C"]}

    circular_proteins_input = {"precursor_idx": [1,2,3,4], "proteins": ["A;B;C", "B;C;D", "C;D;E", "D;E;A"], "decoy": [0,0,0,0]}
    circular_proteins_expected = {"precursor_idx":[1,2,3,4], "proteins":["A;B;C", "B;C;D", "C;D;E", "D;E;A"], "decoy": [0,0,0,0], "pg_master":["C","C","C","A"], "pg":["C;B", "C;B", "C;B", "A;D;E"]}

    complex_example_proteins_input = {"precursor_idx": [0,1,2,3], "proteins": ["P1;P2;P3;P4", "P1;P4", "P2", "P2;P5"], "decoy": [0,0,0,0]}
    complex_example_proteins_expected = {"precursor_idx":[0,1,2,3], "proteins":["P1;P2;P3;P4", "P1;P4", "P2", "P2;P5"], "decoy": [0,0,0,0], "pg_master":["P2", "P1", "P2", "P2"], "pg":["P2;P3;P5","P1;P4","P2;P3;P5","P2;P3;P5"]}
