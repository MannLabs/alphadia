...
parser.add_argument("--size", type=int, default=100, help="size of the test in percent")
...
parser.add_argument("--n-iter", type=int, default=20, help="number of iterations")

parser.add_argument(
    "--max-batch-size", type=int, default=10000, help="maximum batch size"
)

parser.add_argument(
    "--min-batch-number", type=int, default=100, help="minimum batch number"
)
...
parser.add_argument(
    "--layers", type=str, default="100,50,20,5", help="number of layers"
)
